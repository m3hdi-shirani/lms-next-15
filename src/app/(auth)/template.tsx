...
const AuthTemplate = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="fade-in container pl-0 flex max-w-6xl dark:bg-base-50/20 !mt-16 rounded-lg border dark:border-base-content/10 shadow-lg">
      ...
      <section className="flex-1 p-10">
        <div className="dark:bg-primary-focus rounded-lg shadow-lg dark:text-white flex flex-col items-center justify-around text-center p-6">
          ...
          <div className="dark:bg-primary/50 p-2 rounded-full w-80 h-80 my-8 flex justify-center items-center">
            <div className="dark:bg-primary/90 p-2 rounded-full w-72 h-72 my-6 flex justify-center dark:border-white/10 border relative">
              <Image
                priority
                fill
          ...
          <div>
            <h4 className="text-xl">یادگیری برنامه نویسی در کوتاه ترین زمان</h4>
            <h6 className="mt-3">اینجا سریع سر اصل مطلب می رویم!</h6>
          </div>
        </div>
      </section>
    </div>
